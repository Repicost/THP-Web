            ...
            <!--div class="carousel-item active" style="background-image: url('http://placehold.it/1900x1080')"-->
  		   <div class="carousel-item active" style="background-image: url('img/1.jpg')">
              ...
              <div class="carousel-caption d-none d-md-block">
                <h3>THP Transport Services</h3>
                <p>The Best Solution to getting anywhere</p>
              </div>
            </div>
            <!-- Slide Two - Set the background image for this slide in the line below -->
            <div class="carousel-item" style="background-image: url('img/slide.png')">
              <div class="carousel-caption d-none d-md-block">
                <h3>THP Transport Services</h3>
                <p>Engaged in promoting local tourism of the country</p>
              </div>
            </div>
            <!-- Slide Three - Set the background image for this slide in the line below -->
            <div class="carousel-item" style="background-image: url('img/inside.jpg')">
              <div class="carousel-caption d-none d-md-block">
                <h3>THP Transport Services</h3>
                <p>We assure that all guests can travel safe and with comfort</p>
              </div>
            </div>
          </div>
